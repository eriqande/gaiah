...
Then plot those at the first bird to see what they look like
```{r quick-combo-plot}
par(mfrow = c(2,2))
plot(Mgen[[100]], main = "Gen")
plot(Miso[[100]], main = "Iso")
plot(Mhab_norm, main = "Hab")
plot(Combo[[100]], main = "Combo")
```
